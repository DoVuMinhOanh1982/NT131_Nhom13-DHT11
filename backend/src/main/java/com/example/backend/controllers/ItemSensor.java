...
public class ItemSensor {
    ...
    public ResponseEntity<Humidity> sensorSentHumidityData(
            @Valid @RequestBody HumidityRequest humidityRequest) {
        return ResponseEntity.status(HttpStatus.OK).body(
                humidityService.sensorSentHumidityData(humidityRequest));
    }
}
